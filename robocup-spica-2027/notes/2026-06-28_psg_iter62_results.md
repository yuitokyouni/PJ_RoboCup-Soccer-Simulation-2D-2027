...
| label | binary | N | mean_goal_diff | se | ci95 |
|-------|--------|---|----------------|----|------|
| iter-62 variant  | v3-snapshot           | TBD | TBD | TBD | TBD |
| baseline         | v3-noTMR-snapshot     | TBD | TBD | TBD | TBD |

| delta | mean | combined se | 95 % ci |
|-------|------|-------------|---------|
| variant − baseline | TBD | TBD | TBD |

## Match-by-match (iter-62 variant)
