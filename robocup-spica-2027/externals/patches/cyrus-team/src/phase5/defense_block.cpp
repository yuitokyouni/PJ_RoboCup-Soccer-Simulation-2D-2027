    ...
    const rcsc::Vector2D & raw_target )
{
    ...
    if ( attacking ) {
        ...
        // iter 11 u9 push reverted in iter 12 (lost 0-1 despite
        // record opp_half=1019). Pivot: revert Y-symmetric F433
        // conf to vanilla -- balanced n=30 said pre-Y-sym was -0.77
        // vs current REV -0.93.
